    ...
    learnings: [
      {
        ...
        contents: [
          ...
          "사용자 피드백을 바탕으로, **단시간에 “내가 어떤 사람인지”를 직관적으로 이해하고 싶어한다는 니즈**를 확인했고, 이에 따라 **카드형 UI 도입**과 **인트로 문구의 상단 배치**를 통해 정보 전달 방식을 재구성했습니다. 이러한 시도 덕분에 **제가 지향하는 개발자상을 짧고 명확하게 전달**할 수 있었고, 실제로 서류 합격률이 2% 상승하는 성과로 이어졌습니다.",
